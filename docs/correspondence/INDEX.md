...
| 2026-08-09 | UDIS → FFPE | Consolidated response: inherited thread + independent review findings       | `docs/correspondence/2026-08-09-udis-to-ffpe-consolidated-response.md` (this repo; relocated here from `udis-platform` after the privacy ruling, content unchanged) | Superseded — see `-portability-and-currency-count` row |
| 2026-08-09 | FFPE → UDIS | Reply renamed to convention: currency count, COM/burden-pool reframing, open questions | `docs/correspondence/2026-08-09-ffpe-to-udis-portability-and-currency-count.md` (supersedes `docs/udis-review-response.md`) | Replied |
| 2026-08-09 | UDIS → FFPE | Hold notice: 13-file diff found uncommitted, sequencing not content | `docs/correspondence/2026-08-09-udis-to-ffpe-hold-for-approval.md` | Resolved — diff landed as `c80caf3` after owner review |
| 2026-08-09 | FFPE → UDIS | Full review of UDIS's Charter, capability assessment, reality check, assumptions and open items (owner-requested, relayed directly rather than via a file) | No file this side — see UDIS's `EC-021` through `EC-024` and `purpose-statement-proposal-2026-08-09.md` for what it produced | Replied — see next row |
| 2026-08-09 | UDIS → FFPE | Response to the review: what was adopted, one refinement pushed back (A4 framing), one correction to this office's own earlier "unsolicited" characterisation | `docs/correspondence/2026-08-09-udis-to-ffpe-response-to-review.md` | **Awaiting FFPE reply, if any — none required** |
